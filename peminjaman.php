      ...
      <div class="row">
        ...
        <div class="col-sm-3 col-md-2 sidebar" style="background-color: #364958">
          ...
          <li class=""><a href="dashboard.php" style="color: #ffffff"><i class="fa fa-dashboard">&nbsp;&nbsp;&nbsp;Dashboard</i></a></li>
            ...
            <li><a href="peminjaman.php" style="background-color: #87bba2"><i class="fa fa-gear"style="color: #364958">&nbsp;&nbsp;&nbsp;Peminjaman</i></a></li>
  ...
  color: #ffffff;">
          ...
          <div class="row">
            <a href="tambahpeminjaman.php" class="btn btn-danger pull-right"><i class="fa fa-plus"></i> Tambah</a>
              ...
              <table id="tabelpeminjaman" style="background-color:#55828b" class="table table-bordered  table-hover" >
                     <thead >
                        <tr >
                          <th>No</th>
                          <th>Nama Barang</th>
